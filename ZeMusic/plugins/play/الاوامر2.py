...
※ لاظهار كيبورد الاعضاء اضغط /rd/n
...
※ استخدم الازرار لمعرفه الاوامر المستخدمه. """,
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [InlineKeyboardButton("ՏOᑌᖇᑕᗴ ᖇ3ᗪ", url=f"https://t.me/rr_yn7"),
...
InlineKeyboardButton(" member keyboard ", callback_data="Q_XUQ"),
                ...
                [                
                    ...
                    InlineKeyboardButton(" Donate ", url=f"https://t.me/rr_yn7"),
                ],
                [
                    InlineKeyboardButton(
                    ...
                    InlineKeyboardButton(
                        "‹ المطور ›", url=f"https://t.me/F_b_i_z"
                    ),
                ],
                [
                    InlineKeyboardButton(
