...
def stream_markup_timer(_, chat_id, played, dur):
    ...
    buttons = [
         ...
         InlineKeyboardButton(text="‣‣I", callback_data=f"ADMIN Skip|{chat_id}"),
            ...
            InlineKeyboardButton(text="𝗗𝗲𝘃 𝘀𝗼𝘂𝗿𝗰𝗲", url=f"https://t.me/F_b_i_z"),
        ],[
            InlineKeyboardButton(text="ضفني في جروبك يحلو🥺", url=f"https://t.me/{app.username}?startgroup=true")],
    ]
    return buttons
